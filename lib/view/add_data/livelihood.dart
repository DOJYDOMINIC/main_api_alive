...
class _SalesState extends State<LivelihoodValue> {
  ...
  TextEditingController livelihoodGoatAttapadiBlackQnty =
      TextEditingController();
  TextEditingController livelihoodGoatAttapadiBlackKidQnty =
      TextEditingController();
  ...
  TextEditingController livelihoodPoultryEggProductionQnty =
      TextEditingController();
  TextEditingController livelihoodPoultryMarketingQnty =
      TextEditingController();
                  ...
                  if (fooderlist.contains('FOR SALE'))
                    InputField(
                      ...
                      onchanged: (value) {
                        int? valuee = int.tryParse(value);
                        providerone
                            .updateDataLivelihoodFodderForSaleQnty(valuee);
                      },
                      keytype: TextInputType.number,
                    ),
                  if (fooderlist.contains('OWN USE'))
                    InputField(
                      ...
                      onchanged: (value) {
                        int? valuee = int.tryParse(value);
                        providerone
                            .updateDataLivelihoodFodderOwnUseQnty(valuee);
                      },
                      keytype: TextInputType.number,
                    ),
                  ...
                  if (goatlistitems.contains('ATTAPADI BLACK KID'))
                    InputField(
                      ...
                      onchanged: (value) {
                        int? valuee = int.tryParse(value);
                        providerone
                            .updateDataLivelihoodGoatAttapadiBlackKidQnty(
                                valuee);
                      },
                      keytype: TextInputType.number,
                    ),
                  if (goatlistitems.contains('MALABARI'))
                    InputField(
                      ...
                      onchanged: (value) {
                        int? valuee = int.tryParse(value);
                        providerone
                            .updateDataLivelihoodGoatMalabariQnty(valuee);
                      },
                      keytype: TextInputType.number,
                    ),
                  ...
                  if (poultrylistselcted.contains('EGG PRODUCTION'))
                    InputField(
                      ...
                      onchanged: (value) {
                        int? valuee = int.tryParse(value);
                        providerone
                            .updateDataLivelihoodPoultryEggProductionQnty(
                                valuee);
                      },
                      keytype: TextInputType.number,
                    ),
                  ...
                  if (dataLivelihoodIncomesource.contains('POULTRY MANURE'))
                    InputField(
                      ...
                      onchanged: (value) {
                        int? valuee = int.tryParse(value);
                        providerone
                            .updateDataLivelihoodPoultryManureQnty(valuee);
                      },
                      keytype: TextInputType.number,
                    ),
