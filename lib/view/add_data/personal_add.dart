...
import 'package:main200623/model/add_data.dart';
...
class _PersonalPageState extends State<PersonalPage> {
  ...
  void submitForm() {
    final String name = dataName.text;
    final String address = dataAddress.text;

    final AddData data = AddData(
      dataName: name,
      dataAddress: address,
      // members: [Member(dataFamilydetailsNameoffailyfmember: dataFamilydetailsNameoffailyfmember, dataFamilydetailsRelation: dataFamilydetailsRelation, dataFamilydetailsAgeoffamilymember: dataFamilydetailsAgeoffamilymember, dataFamilydetailsEducation: dataFamilydetailsEducation, dataFamilydetailsJob: dataFamilydetailsJob, dataFamilydetailsSkill: dataFamilydetailsSkill)],
    );

    final String jsonData = addDataToJson(data);

    // Process or send jsonData as needed
    // e.g., send to an API,, etc. save locally
    print(jsonData);
  }
